...
-- and unit variance. For the first 500 values the output is clipped to @(-0.5, 0.5)@.
...
normaliseToZeroMeanUnitVariance wel x
  | welfordCountUnsafe wel < 500 = clipValue 0.5 $ (x `minus` mean) `divide` squareRootMax variance
